...
class OrganizerRepository {
    private readonly _model = Organizer;

    // ========================================================================
    // CREATE
    // ========================================================================

    async create(data: { firstName: string; lastName: string; email: string; phone: string; role?: string; status?: string }) {
    ...
    async updateOrganization(id: string, organization: { name?: string; logo?: string; description?: string }) {
        return this._model.findByIdAndUpdate(
            id,
            { organization },
            { new: true }
