...
registrationRouter.post(
    ...
    registrationIdValidator,
    validateRequest,
    asyncHandler(withdrawRegistration)
);
...
registrationRouter.get(
    ...
    tournamentRegistrationsValidator,
    validateRequest,
    asyncHandler(getRegistrationsByTournament)
);
...
registrationRouter.get(
    ...
    categoryIdValidator,
    validateRequest,
    asyncHandler(getRegistrationsByCategory)
);
...
registrationRouter.post(
    ...
    bulkApproveValidator,
    validateRequest,
    asyncHandler(bulkApproveRegistrations)
);
...
registrationRouter.post(
    ...
    assignToTeamValidator,
    validateRequest,
    asyncHandler(assignPlayerToTeam)
);
...
registrationRouter.post(
    ...
    manualAssignValidator,
    validateRequest,
    asyncHandler(manualAssignPlayer)
);
...
registrationRouter.get(
    ...
    teamIdValidator,
    validateRequest,
    asyncHandler(getTeamRoster)
);

// Get available players for auction
registrationRouter.get(
    '/categories/:categoryId/available',
    isOrganizerLoggedIn,
    categoryIdValidator,
    validateRequest,
    asyncHandler(getAvailableForAuction)
);
